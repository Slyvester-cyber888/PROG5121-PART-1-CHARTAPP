...
|----------------------------------|------------------------|-----------------|
| Username correctly formatted     | `Syv_8`                | `true` / Registration successful |
| Username incorrectly formatted   | `Slyvester!!!!!!`           | `false` / Error message |
| Password meets complexity        | `Ch&seck9`         | `true` |
...
Student Name: [Slyvester Sibonakaliso]  
